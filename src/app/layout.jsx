...
function WhatsAppFloat() {
  return (
    ...
    >
      <div className="w-10 h-10 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-float transition-transform duration-200 hover:scale-110">
