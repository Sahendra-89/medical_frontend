    ...
    <div className="min-h-screen bg-slate-50 flex flex-col pb-20">
      <section className="bg-[#111827] text-white pt-20 pb-20 px-4 sm:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl sm:text-6xl font-black mb-6">Healthcare that rewards you.</h1>
          <p className="text-slate-300 text-lg mb-10 max-w-xl mx-auto">
            Join the PLUS membership program to get flat 5% extra cashback on all medicines, free delivery, and priority doctor consultations.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-8 -mt-10 relative z-20 w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-xl text-center flex flex-col items-center">
            ...
            <h3 className="font-black text-xl text-slate-800 mb-3">Extra 5% Cashback</h3>
            <p className="text-slate-500 text-sm">Earn an extra 5% cashback on every single medicine and healthcare order.</p>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-xl text-center flex flex-col items-center">
            ...
            <h3 className="font-black text-xl text-slate-800 mb-3">Free Delivery</h3>
            <p className="text-slate-500 text-sm">No minimum order value required. Get your medicines delivered for free.</p>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-xl text-center flex flex-col items-center">
            ...
            <h3 className="font-black text-xl text-slate-800 mb-3">Priority Support</h3>
            <p className="text-slate-500 text-sm">Jump the queue. Get priority access to customer support and doctor consults.</p>
          </div>
        </div>
      </section>
    </div>
