  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-12 flex-1 w-full">
      <Breadcrumbs items={[
        ...
        ...(product.category_id ? [{ label: product.category_id, href: `/shop?category=${product.category_id}` }] : []),
        { label: product.name }
      ]} />
        ...
        <div className="lg:col-span-7 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-6 pt-4 border-t border-slate-100 flex-1">
              <div>
                <h3 className="font-bold text-sm text-slate-900 mb-2">Advantages & Description</h3>
                <p className="text-xs text-slate-600 leading-relaxed">{product.description}</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                  <h4 className="font-bold text-xs text-slate-900 mb-1 flex items-center gap-1.5"><CheckCircle size={14} className="text-medical-blue" /> Uses & Instructions</h4>
